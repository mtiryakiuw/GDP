...
\textbf{Main Effects:}
\begin{itemize}
    \item Industry: \textcolor{red}{+4.089***}
    \item Construction: +1.343 n.s.
    \item Public Sector: \textcolor{green!60!black}{-2.860***}
    \item High-Skill: \textcolor{red}{+2.520***}
    \item Managerial: \textcolor{red}{+4.540***}
\end{itemize}
...
\begin{itemize}
    ...
    \item Industry × Manager: \textcolor{green!60!black}{-3.253*}
...
\begin{itemize}
    \item \textbf{Glass ceiling effects:} High-skill (+2.5 pp) and managerial (+4.5 pp) face larger gaps
    \item \textbf{Industry offset:} High-skill workers in Industry face \textit{smaller} penalties (-3.4 pp interaction)
    \item \textbf{Public sector reversal:} Public advantage disappears for high-skill (+4.8 pp) but strengthens for managers (-5.4 pp)
\end{itemize}
\end{alertblock}
