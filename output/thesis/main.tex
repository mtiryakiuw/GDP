...
\small
\textit{Source:} Own calculation based on: Structure of Earnings Survey, Eurostat, 2010-2022.
\textit{Notes:} All specifications use Random Effects with sector-occupation interactions and cluster-robust SEs (omitted for space). EU-15 (pre-1995 members): Austria, Belgium, Germany, Denmark, Spain, Finland, France, United Kingdom, Greece, Ireland, Italy, Luxembourg, Netherlands, Portugal, Sweden. New Member States (post-2004 accessions): Bulgaria, Cyprus, Czech Republic, Estonia, Croatia, Hungary, Lithuania, Latvia, Malta, Poland, Romania, Slovenia, Slovakia. Eurozone (19 countries using euro currency, 2022 membership): Austria, Belgium, Cyprus, Germany, Estonia, Spain, Finland, France, Greece, Ireland, Italy, Lithuania, Luxembourg, Latvia, Malta, Netherlands, Portugal, Slovenia, Slovakia. *** p<0.001, ** p<0.01, * p<0.05
\end{tablenotes}
\end{table}
