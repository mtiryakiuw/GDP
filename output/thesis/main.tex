...
The economic analysis of gender wage differences relies on three main theories that explain lasting pay gaps. Human capital theory, from \cite{becker1964} and \cite{mincer1974}, says wage gaps come from differences in education, training, and work experience. Here, women earn less because they have fewer chances to gain work experience and job-specific skills, often due to family responsibilities \cite{polachek1981}. Even when education and experience are accounted for, recent studies find much of the wage gap remains unexplained \cite{blau2017}.

Statistical discrimination theory, from \cite{phelps1972} and \cite{arrow1973}, explains wage gaps through limited information. Employers use group averages to judge job candidates. If they think women may leave jobs more often or work less because of family, they might offer all women lower wages. This discourages women from investing in skills, thereby perpetuating the gap \cite{coate1993}. Studies show this type of discrimination is worse in male-dominated fields, where employers lack experience with women workers \cite{card2016}.

Taste-based discrimination, introduced by \cite{becker1957}, holds that pay gaps result from biases among employers, coworkers, or customers. Prejudiced employers are willing to lose some profit to avoid hiring or promoting women. This causes wage penalties in markets lacking competition. While competition should erase discrimination over time, research shows it endures in some fields \cite{charles2008}. How taste-based and statistical discrimination interact leads to varied patterns of wage gaps across different workplaces \cite{altonji2001}.

Recent theories use behavioral economics to explain discrimination. \cite{bohren2019} describes "inaccurate statistical discrimination," where employers have unjustified beliefs about group differences. This explains why wage gaps can last even in fair, competitive settings. \cite{bordalo2019} uses salience theory and shows that stereotypes affect pay, depending on the situation. These approaches help explain why discrimination stays, despite competition, and why its effects differ by job.
...
\cite{kunze2008} links fixed effects with decomposition to track wage gaps within individuals over time. Random effects models, with stronger assumptions, enable the estimation of gender coefficients and time-varying selection patterns \cite{wooldridge2010}.
...
\cite{chernozhukov2018} introduced double machine learning to gender wage gap analysis, combining predictive accuracy and causal inference. Using German data, they found linear models understate wage gaps by 3-5 points due to complex interactions between occupation, industry, and experience. \cite{firpo2009} extends this to distributive analysis, finding larger errors at the extremes of the wage distribution, where gender gaps peak.

Synthetic control methods enable the evaluation of policy interventions in settings with limited treatment units. \cite{arkhangelsky2021} apply synthetic difference-in-differences to analyze Iceland's equal pay certification requirement, constructing synthetic controls from other Nordic countries. They find that mandatory certification reduced gender wage gaps by 4-6 percentage points, with effects concentrated among large private-sector firms. \cite{gobillon2008} develop spatial panel methods that account for regional spillovers in wage-setting, finding that local labor-market competition significantly moderates gender wage gaps.



\subsection{Recent Evidence from Pandemic-Era Labor Markets}

The COVID-19 pandemic created unprecedented disruptions to labor markets with distinctly gendered impacts. \cite{alon2021} analyzes employment and wage dynamics across European countries from 2020 to 2022, documenting initial "she-cession" patterns in which women's employment declined more rapidly than men's. However, wage gaps among continuously employed workers narrowed by 2-3 percentage points, driven by sectoral composition effects and accelerated adoption of flexible work arrangements. \cite{adamsprassl2020} examines UK data and finds that pandemic-induced remote work particularly benefited mothers, reducing wage penalties associated with workplace flexibility.

Sectoral heterogeneity in pandemic impacts reveals important mechanisms underlying gender wage gaps. \cite{albanesi2021} document that essential worker assignments, which disproportionately covered female-dominated healthcare and education sectors, led to relative wage gains for women in these occupations. Conversely, discretionary service sectors with high female employment experienced persistent wage scarring. \cite{bluedorn2021} analyzes fiscal support programs across EU countries, finding that short-time work schemes better preserved women's jobs and wages compared to expansions of unemployment insurance.
