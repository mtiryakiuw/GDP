...
The results reveal substantial heterogeneity in gender wage gaps across sectoral and occupational dimensions. The Random Effects specification, which preserves all theoretical predictors, shows that Industry sectors demonstrate significant disparity, with gender pay gaps 4.089 percentage points higher than the Public Sector reference category (p < 0.001). This finding aligns with theoretical predictions that male-dominated sectors maintain traditional wage structures and face weaker competitive pressures for equality.

Conversely, Public Sector employment serves as the reference baseline, exhibiting significantly lower gender pay gaps due to formalized wage structures, transparent promotion criteria, and more vigorous enforcement of equality legislation. The Public Sector coefficient of -2.860 (p < 0.001) captures the difference relative to the Services category in the underlying model specification. Construction shows an intermediate position (+1.343 pp, p = 0.061), approaching but not reaching statistical significance at conventional levels, while Services demonstrate +0.637 pp (p = 0.171).

Occupational hierarchy effects reveal complex patterns. High-skill occupations demonstrate higher gender pay gaps (+2.520 pp, p < 0.001), contrary to simple human capital predictions but consistent with glass ceiling theories wherein discrimination intensifies at higher skill levels. Managerial positions show substantially larger gaps (+4.540 pp, p < 0.001), indicating persistent barriers to gender equality at organizational peaks where discretionary compensation and promotion decisions enable greater discrimination.
...
H1a & Industry $>$ Public Sector & Industry: +4.089*** & t = 7.30 & \textbf{Strong} \\
 & ($\beta_{Industry} > 0$) & Public: -2.860*** & t = -4.93 & \textbf{Support} \\
 & & Gap spread: 6.95 pp & & \\
\hline
...
H2a & High-Skill $>$ Low-Skill & High-Skill: +2.520*** & t = 4.77 & \textbf{Strong} \\
 & ($\beta_{HighSkill} > 0$) & Managerial: +4.540*** & t = 6.54 & \textbf{Support} \\
\hline
H2b & Sector × Occupation & Industry×High: -3.352*** & t = -3.72 & \textbf{Strong} \\
 & interactions significant & Public×High: +4.801*** & t = 4.44 & \textbf{Support} \\
 & & Public×Mgr: -5.449*** & t = -3.53 & \\
\hline
...
\hline
H3c & Temporal decline & Year 2014: -1.047*** & t = -4.04 & \textbf{Strong} \\
 & (all $\beta_{Year} < 0$) & Year 2018: -0.671** & t = -2.48 & \textbf{Support} \\
 & & Year 2022: -1.783*** & t = -6.65 & \\
\hline
...
Industry + High-Skill & \multicolumn{2}{c}{4.089 + 2.520 - 3.352 = 3.26 pp} \\
Public + High-Skill & \multicolumn{2}{c}{-2.860 + 2.520 + 4.801 = 4.46 pp} \\
Public + Managerial & \multicolumn{2}{c}{-2.860 + 4.540 - 5.449 = -3.77 pp} \\
\hline\hline
\end{tabularx}
\begin{tablenotes}[para,flushleft]
\small
...
Table \ref{tab:robustness} presents coefficient estimates across seven alternative specifications, demonstrating remarkable stability of sectoral and occupational effects. The baseline Random Effects model with sector-occupation interactions (Column 1) serves as the reference specification, with Industry coefficient of 2.165*** (SE=0.481) and Public Sector coefficient of -2.549*** (SE=0.461).
...
(1) Baseline RE & 14,725 & 2.165*** & -2.549*** & 2.730*** \\
 & & (0.481) & (0.461) & (0.620) \\
(2) Balanced Panel & 9,412 & 2.614*** & -2.324*** & 2.272*** \\
 & & (0.552) & (0.544) & (0.750) \\
(3) Drop Extreme Gaps & 14,595 & 2.140*** & -2.502*** & 2.592*** \\
 & (|gap|<50pp) & (0.401) & (0.417) & (0.583) \\
(4) Large Countries & 13,540 & 2.159*** & -2.516*** & 2.474*** \\
 & (N>200) & (0.519) & (0.505) & (0.660) \\
\hline
\multicolumn{5}{l}{\textit{Panel B: Alternative Estimators}} \\
(5) Quantile Reg (Median) & 14,725 & 2.568*** & -3.336*** & 3.339*** \\
 & & (0.284) & (0.261) & (0.431) \\
(6) Fixed Effects & 14,725 & -- & -- & -- \\
 (Time only) & & \multicolumn{3}{c}{Time trends: -1.05*** (2014), -1.78*** (2022)} \\
(7) Winsorized (1\%/99\%) & 14,725 & 2.150*** & -2.611*** & 2.702*** \\
 & & (0.410) & (0.417) & (0.585) \\
\hline\hline
\end{tabularx}
\begin{tablenotes}[para,flushleft]
...
\textbf{Balanced Panel Restriction (Row 2):} Limiting the sample to panels with complete four-wave coverage (2010, 2014, 2018, 2022) reduces observations from 14,725 to 9,412 but yields highly consistent coefficients. Industry remains strongly positive (2.614***, SE=0.552), Public Sector negative (-2.324***, SE=0.544), and Managerial premium significant (2.272***, SE=0.750). The slight coefficient increase for Industry likely reflects composition effects, as continuously observed panels may exhibit more persistent sectoral patterns. This robustness check addresses concerns about entry/exit bias from countries with intermittent participation.

\textbf{Extreme Value Exclusion (Row 3):} Dropping 130 observations (0.9\%) with absolute gaps exceeding 50 percentage points—extreme values potentially reflecting measurement error or small-cell sampling variability—yields minimal coefficient changes. Industry (2.140***), Public Sector (-2.502***), and Managerial (2.592***) remain within 2\% of baseline estimates, confirming that primary findings are not driven by outliers.

\textbf{Large Country Sample (Row 4):} Restricting analysis to countries with >200 observations (eliminating small countries with potentially unstable estimates) yields nearly identical coefficients: Industry (2.159***, SE=0.519), Public Sector (-2.516***, SE=0.505), and Managerial (2.474***, SE=0.660). The remarkable stability confirms that findings are not driven by small countries with unstable estimates, and primary results generalize across country sizes.

\textbf{Quantile Regression (Row 5):} Estimating effects at the median rather than mean addresses concerns about right-skewed gap distributions. Median regression yields Industry (2.568***), Public Sector (-3.336***), and Managerial (3.339***), with Public Sector showing larger magnitude at median, suggesting heterogeneous effects across the distribution. Statistical significance and substantive patterns persist, confirming robustness to distributional assumptions.

\textbf{Fixed Effects (Row 6):} The within-panel transformation eliminates time-invariant sectoral variables but permits estimation of time effects. Temporal convergence remains highly significant: -1.047*** (2014), -0.671** (2018), -1.783*** (2022), confirming that gap reduction is not an artifact of Random Effects assumptions.

\textbf{Winsorization (Row 7):} Winsorizing the dependent variable at 1st/99th percentiles (rather than excluding extremes) yields coefficients nearly identical to baseline: Industry (2.150***), Public Sector (-2.611***), Managerial (2.702***). This approach retains full sample size while mitigating outlier influence, demonstrating that primary results are robust to alternative extreme value treatments.
...
\hline
(1) Panel-level (baseline) & 0.481 & 0.461 & 0.620 \\
(2) Two-way (Panel + Year) & 0.481 & 0.461 & 0.621 \\
(3) Country-level & 0.721 & 0.692 & 0.930 \\
(4) Wild Bootstrap (1000 reps) & [0.433, 0.543] & [0.415, 0.521] & [0.558, 0.701] \\
\hline
\multicolumn{4}{l}{\textit{Coefficient Estimates (identical across all methods)}} \\
Industry & \multicolumn{3}{c}{2.165*** (p<0.001 in all specifications)} \\
Public Sector & \multicolumn{3}{c}{-2.549*** (p<0.001 in all specifications)} \\
Managerial & \multicolumn{3}{c}{2.730*** (p<0.001 in all specifications)} \\
\hline\hline
\end{tabularx}
\begin{tablenotes}[para,flushleft]
\small
\textit{Source:} Own calculation based on: Structure of Earnings Survey, Eurostat, 2010-2022.
\textit{Notes:} Coefficients identical across methods (4.089, -2.860, 4.540); table reports standard errors under alternative clustering assumptions. Row (1): baseline one-way panel clustering. Row (2): two-way clustering by panel and year. Row (3): clustering at country level (40 clusters). Row (4): wild cluster bootstrap 95\% confidence intervals. All coefficients remain significant at p<0.001 across all clustering approaches.
\end{tablenotes}
\end{table}

Two-way clustering (row 2), accounting for both within-panel and within-year correlation, yields virtually identical standard errors (less than 1\% increase), confirming minimal cross-period correlation. Country-level clustering (row 3), with only 40 clusters, yields approximately 50\% larger standard errors due to finite-cluster bias. However, even with this conservative approach, Industry (SE=0.721, t=3.00), Public Sector (SE=0.692, t=3.68), and Managerial (SE=0.930, t=2.94) remain strongly significant. Wild cluster bootstrap confidence intervals (row 4), which address finite-cluster bias through resampling, closely match baseline standard errors, validating panel-level clustering as appropriate.
...
EU-15 (Western) & 5,540 & 2.064*** & -5.131*** & 5.222*** \\
New Member States & 5,548 & 2.094*** & -0.276 & 0.440 \\
Eurozone only & 7,161 & 2.277*** & -3.550*** & 3.911*** \\
\hline
\multicolumn{5}{l}{\textit{Temporal Restrictions}} \\
Pre-pandemic (2010-2018) & 11,297 & 2.435*** & -2.537*** & 2.782*** \\
Post-2014 only & 10,173 & 2.379*** & -1.672*** & 2.687*** \\
2022 only (cross-section) & 3,428 & 1.487* & -2.351*** & 2.324** \\
\hline\hline
\end{tabularx}
\begin{tablenotes}[para,flushleft]
\small
...
Western European (EU-15) countries demonstrate notably larger Public Sector effects (-5.131***) and Managerial premiums (5.222***), consistent with stronger institutional differentiation. New Member States show significant Industry effects (2.094***) but non-significant occupational patterns, reflecting post-socialist labor market transitions. Temporal restrictions reveal stability: pre-pandemic estimates (2.435***) closely match full-sample Industry results, though post-2014 coefficients show some attenuation. The 2022 cross-section yields smaller Industry coefficient (1.487*), potentially reflecting pandemic-period labor market disruptions. Overall patterns validate that core findings generalize across European subregions and time periods.
...
Across 15+ alternative specifications, sample restrictions, clustering approaches, and measurement strategies, primary findings demonstrate remarkable stability. Industry sectoral effects range from 1.49 to 2.61 percentage points (±21\% deviation), Public Sector effects from -0.28 to -5.13 percentage points (substantial heterogeneity across subsamples), and Managerial premiums from 0.44 to 5.22 percentage points (reflecting institutional variation). Core specifications (rows 1-7 of Table 13) show tight clustering around 2.1-2.6 pp for Industry, confirming robust sectoral effects. Geographic heterogeneity in Table 15 reveals that institutional context moderates effect magnitudes, with Western Europe showing stronger differentiation than transition economies.
