...
Diagnostic testing reveals significant serial correlation (Breusch-Godfrey/Wooldridge test: $\chi^2$ = 1144.3, df = 1, p < 2.2e-16) and heteroskedasticity, necessitating the use of robust estimation procedures. The analysis implements several complementary approaches:
